...
def validate_array_shape(array: np.ndarray, min_height: int = None, min_width: int = None, help: str = ""):
    """
    ...
    Parameters:
        ...
        help (int, optional): Message appended to the raised exception. Defaults to empty string.
